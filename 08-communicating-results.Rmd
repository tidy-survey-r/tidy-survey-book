...
if (knitr::is_latex_output()) {
  trust_gov_gt %>%
    as_latex_with_caption("results-table-gt1-tab")
}
if (knitr::is_html_output()) {
  trust_gov_gt %>% 
    tab_caption("(ref:results-table-gt1-tab)")
}
```
...
if (knitr::is_latex_output()) {
  trust_gov_gt2 %>%
    as_latex_with_caption("results-table-gt2-tab")
}
if (knitr::is_html_output()) {
  trust_gov_gt2 %>% 
    tab_caption("(ref:results-table-gt2-tab)")
}
```
...
if (knitr::is_latex_output()) {
  anes_des_gtsum %>%
    as_latex_with_caption("results-gts-ex-1-tab")
}
if (knitr::is_html_output()) {
  anes_des_gtsum %>% 
    tab_caption("(ref:results-gts-ex-1-tab)")
}
```
-->
...
if (knitr::is_latex_output()) {
  anes_des_gtsum2 %>%
    as_latex_with_caption("results-gts-ex-2-tab")
}
if (knitr::is_html_output()) {
  anes_des_gtsum2 %>% 
    tab_caption("(ref:results-gts-ex-2-tab)")
}
```
-->
...
if (knitr::is_latex_output()) {
  anes_des_gtsum3 %>%
    as_latex_with_caption("results-gts-ex-3-tab")
}
if (knitr::is_html_output()) {
  anes_des_gtsum3 %>% 
    tab_caption("(ref:results-gts-ex-3-tab)")
}
```
-->
...
if (knitr::is_latex_output()) {
  anes_des_gtsum4 %>%
    as_latex_with_caption("results-gts-ex-4-tab")
}
if (knitr::is_html_output()) {
  anes_des_gtsum4 %>% 
    tab_caption("(ref:results-gts-ex-4-tab)")
}
```
-->
...
if (knitr::is_latex_output()) {
  anes_des_gtsum5 %>%
    as_latex_with_caption("results-gts-ex-5-tab")
}
if (knitr::is_html_output()) {
  anes_des_gtsum5 %>% 
    tab_caption("(ref:results-gts-ex-5-tab)")
}
```
-->
### Charts and Plots
