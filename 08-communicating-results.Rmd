...
if (knitr::is_latex_output()) {
  trust_gov_gt %>%
    as_latex_with_caption("Example of gt table with trust in government estimates")
}
...
if (knitr::is_latex_output()) {
  trust_gov_gt2 %>%
    as_latex_with_caption("Example of gt table with trust
              in government estimates with additional context")
}
if (knitr::is_html_output()) {
  trust_gov_gt2
...
if (knitr::is_latex_output()) {
  anes_des_gtsum %>%
    as_latex_with_caption("Example of gtsummary table with trust 
              in government estimates")
}
if (knitr::is_html_output()) {
  anes_des_gtsum
...
if (knitr::is_latex_output()) {
  anes_des_gtsum4 %>%
    as_latex_with_caption("Example of gtsummary table with trust in 
                          government estimates and average age")
}
if (knitr::is_html_output()) {
  anes_des_gtsum4
}
