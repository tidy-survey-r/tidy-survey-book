...
With {gtsummary}, we can also calculate statistics by different groups. Let's modify the previous example to analyze data on whether a respondent voted for president in 2020. We update the `by` argument and refine the header. \index{Functions in srvyr!drop\_na}
