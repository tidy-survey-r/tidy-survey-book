...
Before beginning any dissemination of results, it is important to understand the audience. Some questions we might consider about our audience include:
  ...
  - In what medium will results be presented? Examples include a website or print media. Based on the media type, we might limit or enhance the use of graphical representation. 
...
### Results
<!-- <JM> Suggest reviewing your tables and charts from previous chapters to ensure you're following your own advice.-->
...
<!-- <JM> Don't get why you use the footnote for % (SE(%)) instead of including those as columns headers. -->
```{r}
...
p
```
<!-- <JM> Not obvious that aes stands for aesthetics. May want to note that. Also, might be nice to show reader how to make Biden blue and Trump red as this is something they'd likely consider doing. -->
...
<!-- <JM> In your examples, you use different seed values and reader might not understand why you chose what you chose, if there was a reason. It shouldn't matter, right? You could use 123 or whatever? Suggest clarifying and simplifying this point. -->
