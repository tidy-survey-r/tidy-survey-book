...
anes_des_sel %>% summarize(p_logit=survey_prop(vartype="ci", prop_method="logit")) %>% filter(VoteOther)
anes_des_sel %>% summarize(p_like=survey_prop(vartype="ci", prop_method="likelihood")) %>% filter(VoteOther)
anes_des_sel %>% summarize(p_asin=survey_prop(vartype="ci", prop_method="asin")) %>% filter(VoteOther)
anes_des_sel %>% summarize(p_beta=survey_prop(vartype="ci", prop_method="beta")) %>% filter(VoteOther)
anes_des_sel %>% summarize(p_mean=survey_prop(vartype="ci", prop_method="mean")) %>% filter(VoteOther)
anes_des_sel %>% summarize(p_xlogit=survey_prop(vartype="ci", prop_method="xlogit")) %>% filter(VoteOther)
```
...
recs_des %>% summarize(p90_mean=survey_quantile(DOLLAREL, .95, vartype="ci", interval_type = "asin"))
recs_des %>% summarize(p90_mean=survey_quantile(DOLLAREL, .95, vartype="ci", interval_type = "beta"))
recs_des %>% summarize(p90_mean=survey_quantile(DOLLAREL, .95, vartype="ci", interval_type = "mean"))
recs_des %>% summarize(p90_mean=survey_quantile(DOLLAREL, .95, vartype="ci", interval_type = "xlogit"))
recs_des %>% summarize(p90_mean=survey_quantile(DOLLAREL, .95, vartype="ci", interval_type = "quantile"))
```
...
anes_des %>% summarize(age_median=survey_median(Age, vartype="ci", interval_type="mean", na.rm=TRUE))
anes_des %>% summarize(age_median=survey_median(Age, vartype="ci", interval_type="score", na.rm=TRUE))
```
