...
2. Subset the data for sub-populations using `srvyr::filter()`, if needed.
...
#### Example 5: Means by sub-group {.unnumbered}
...
#### Example 2: Quartiles by sub-group {.unnumbered}
...
#### Example 5: Medians by sub-group {.unnumbered}
...
#### Example 2: Ratios by sub-group {.unnumbered}
...
#### Example 2: Correlations by sub-group {.unnumbered}

We can explore the correlation between total square footage and electricity consumption based on sub-groups, such as whether A/C is used (`ACUsed`.)
...
#### Example 2: Variability by sub-group {.unnumbered}
...
### Sub-population analysis \index{Functions in srvyr!filter|(} \index{filter|see {Functions in srvyr}}

\index{Sub-population|(}\index{Domain|see {Sub-population}}
