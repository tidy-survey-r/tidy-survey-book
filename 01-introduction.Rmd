...
Surveys of random samples are collected to gather information and provide inference to populations. Initially, statisticians emphasized obtaining purposefully representative samples but the field of probability samples grew over time. This book discusses the analysis phase of the survey process. We assume that you have survey data that has already been collected and weighted, with the most common scenario being that you are using a public use microdata file.
