...
- **Chapter \@ref(c13-ncvs-vignette)**: National Crime Victimization Survey (NCVS) Vignette. A vignette on how to analyze data from the NCVS, a survey in the U.S. that collects information on crimes and their characteristics. This illustrates an analysis that requires multiple files to calculate victimization rates.
