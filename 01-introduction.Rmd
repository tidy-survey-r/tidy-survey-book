...
We work with two key datasets throughout the book: the Residential Energy Consumption Survey [RECS -- @recs-2015-micro] and the American National Election Studies [ANES -- @debell].  To ensure that all readers can follow the examples, we have provided analytic datasets available on OSF^[https://osf.io/gzbkn/?view_only=8ca80573293b4e12b7f934a0f742b957]. If there is any data you need from the book that isn't part of existing packages, we have created a helper function, `read_osf()`, to help you load it. Here's how to use the code to read in the RECS and ANES datasets:
