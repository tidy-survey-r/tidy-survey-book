...
* `read_csv()`: This function is specifically designed to read files with comma separated values (CSV).
* `read_tsv()`: Use this function for files with tab separated values (TSV).
...
Here is what the GSS SPSS data looks like when imported with {haven}.
