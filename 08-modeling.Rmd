...
Here is how you create the design object for the RECS data. More details for this are included in the RECS documentation and Chapter \@ref(c05).

```{r}
#| label: model-recs-des-c07
recs <-read_rds_tsr("recs_2015.rds")
recs_des <- recs %>%
...
add_data <- recs %>% select(DOEID, Region, Urbanicity, TOTSQFT_EN, ACUsed, DOLLAREL) %>%
