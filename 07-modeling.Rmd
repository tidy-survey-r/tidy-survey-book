...
From Figure \@ref(fig:model-logisticexamp-biden-plot), we can see that people who have incomes in most groups (e.g., \$40,000--60,000) have roughly the same probability of voting for Biden regardless of whether they voted early or not. However, those with income in the \$100,000--125,000 group were more likely to vote for Biden if they voted early than if they did not vote early. 
