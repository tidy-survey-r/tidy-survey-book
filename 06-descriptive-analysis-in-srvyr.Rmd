...
Measures of dispersion describe how data is spread around the central tendency. These measures include the range and standard deviation.
...
Multivariate analysis studies the relationship between multiple variables (bivariate analysis concerns the relationship between two variables). The correlation is a number between -1 and +1 that denotes the strength of the linear relationship between two variables.
