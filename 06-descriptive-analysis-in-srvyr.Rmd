...
We can change the proportion method by adding `prop_method`. The available options are: `"logit"`, `"likelihood"`, `"asin"`, `"beta"`, `"mean"`, and `"xlogit"` (run `?survey::svyciprop()` for more information).
