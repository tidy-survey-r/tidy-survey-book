...
Descriptive analysis describes and aggregates the basic quantitative information of survey data. Common descriptive analyses include the frequency of observations, distributions of responses, or the mean of a numeric variable. Running descriptive analysis allows us to investigate our data and gain insight into the information it contains, and it is crucial in forming the basis of our survey analysis.
<!-- Importance of considering the design and sampling of the survey when analyzing data-->
In complex survey analysis, we must consider the available design and sampling elements when conducting descriptive analysis. We must read survey documentation (as described in Chapter 03) and apply the appropriate sampling weights, PSUs, strata, and replicate weights. Neglecting to incorporate these elements can lead to inaccurate descriptive analyses.
...
There are various types of descriptive analysis:
