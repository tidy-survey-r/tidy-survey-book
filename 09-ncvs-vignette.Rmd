...
<!-- <JM> Suggest introducing what the reader will be doing with these data at the beginning of this section to get their heads around all of the details to follow. As is, it just says they'll be working with the data. Also, this chapter includes very few of the visualization tips from the previous chapter. Consider following that through.-->
::: {.prereqbox-header}
...
We will be using data from the National Crime Victimization Survey (NCVS). Here is the code to read in the three datasets that we will be working with:
```{r}
#| label: ncvs-data
#| cache: TRUE
...
vt2b
```
<!-- <JM> Show the full numbers without ^{} in the book. Currently, they appear with ^{}. -->
...
prop2
```
<!-- <JM> Include confidence interval or margin of error here? -->
