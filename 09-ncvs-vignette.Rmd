...
We will discuss four estimate types:
...
Below, we check the derived variables. This is a good point to pause to look at the output of crosswalks between an original variable and a derived to check the logic was programmed correctly and everything ends up in the expected bucket.  
