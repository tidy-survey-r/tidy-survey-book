...
if (knitr::is_latex_output()) {
  covid_worry_country_ests_gt %>%
    as_latex_with_caption("ambarom-est1-tab")
}
if (knitr::is_html_output()) {
  covid_worry_country_ests_gt %>% 
    tab_caption("(ref:ambarom-est1-tab)")
}
```
...
if (knitr::is_latex_output()) {
  covid_educ_ests_gt %>%
    as_latex_with_caption("ambarom-covid-ed-der-tab")
}
if (knitr::is_html_output()) {
  covid_educ_ests_gt %>% 
    tab_caption("(ref:ambarom-covid-ed-der-tab)")
}
```
