...
To read in any data in the book, use the function `read_rds_tsr()` which reads the data file from a directory on OSF where all book data has been placed for sharing. 
