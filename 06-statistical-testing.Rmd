...
chi_ex2_obs %>%
  ...
  facet_wrap( ~ TrustPeople, ncol = 5, labeller = ) +
  geom_point() +
  geom_errorbar(aes(ymin = Observed_low, ymax = Observed_upp)) +
  ylab("Proportion") +
  xlab("") +
