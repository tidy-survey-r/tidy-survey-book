...
Testing against 0 is really rare unless it's a difference. p can't be 0 (binomial is between but not including 0 and 1)
-->
...
Let's say we want to test whether the temperature that U.S. households set their thermostat at night differs depending on the season (comparing summer and winter temperatures). We could set up the hypothesis as follows:
