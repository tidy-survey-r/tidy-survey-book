...
if (knitr::is_latex_output()) {
  chi_ex2_table %>%
    as_latex_with_caption("stattest-chi-ex2-prop1-tab")
}
if (knitr::is_html_output()) {
  chi_ex2_table %>%
  tab_caption("(ref:stattest-chi-ex2-prop1-tab)")
}
```
...
if (knitr::is_latex_output()) {
  chi_ex2_obs_table %>%
    as_latex_with_caption("stattest-chi-ex2-prop2-tab")
}
if (knitr::is_html_output()) {
  chi_ex2_obs_table %>% 
    tab_caption("(ref:stattest-chi-ex2-prop2-tab)")
}
```
...
if (knitr::is_latex_output()) {
  chi_ex3_obs_table %>%
    as_latex_with_caption("stattest-chi-ex3-tab")
}
if (knitr::is_html_output()) {
  chi_ex3_obs_table %>% 
    tab_caption("(ref:stattest-chi-ex3-tab)")
}
```
