...
There are several ways to fix the mismatched names for a successful join. The simplest solution is to rename the data in the shape object before merging. Since there is only one country name in the survey data that differs from the map data, we will rename the map data accordingly.
