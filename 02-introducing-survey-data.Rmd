...
## Error Sources and Weights

The previous section outlined a few considerations for researchers developing a survey and how this can impact the interpretation.  Some types of error can be addressed by adjusting the data using weights, and others need to be addressed during the survey development process. Generally, survey researchers consider there to be 7 main types of error: 
