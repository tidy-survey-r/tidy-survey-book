...
The first step of any survey analysis is bringing the survey data into R. This process is often referred to as importing, loading, or reading in data. Survey files come in different formats depending on the software used to create them. One of the many advantages of R is the flexibility in handling various data formats, regardless of their file extensions. Here are examples of common public-use survey file formats we may encounter:
...
census_data <- get_acs(geography = "tract", variables = "B01003_001", year = 2020, state = "NC")
```
