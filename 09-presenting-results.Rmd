...
Survey analysis can result in an abundance of printed summary statistics and modeling analysis Even with the best analysis, the results can be overwhelming and difficult to comprehend. This is where data visualization plays a key role in our work. By transforming complex data into visual representation, we can recognize patterns, relationships, and trends with greater ease.

R has many packages for creating compelling and insightful data visualization. We will focus on {ggplot2}, a member of the {tidyverse}. This package is a powerful, flexible tool for creating a wide range of data visualization.
...
anes_in <- 
  osfr::read_rds_tsr("anes_2020.rds")
```
